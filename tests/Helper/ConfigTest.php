...
/**
 * Test Case for @see \Zuams\Helper\Config
 */
final class ConfigTest extends TestCase {

  /**
   * @covers \Zuams\Helper\Config::__construct
   * @covers \Zuams\Agent::getConfig
   * @covers \Zuams\Helper\Config::getDefaultConfig
   * @covers \Zuams\Helper\Config::asArray
   */
   ...
   * @covers \Zuams\Agent::getConfig
   * @covers \Zuams\Helper\Config::getDefaultConfig
   * @covers \Zuams\Helper\Config::get
   */
